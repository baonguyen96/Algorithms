...
from introduction_to_algorithm_3e.chapter7.partition import partition
from introduction_to_algorithm_3e.chapter9.selection import select_partition, select_partition_capture_pivot
